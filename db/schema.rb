...
ActiveRecord::Schema.define(version: 20_210_603_033_422) do
  ...
  create_table 'follows', force: :cascade do |t|
    ...
    t.index %w[user_id post_id], name: 'index_follows_on_user_id_and_post_id', unique: true
  ...
  create_table 'replies', force: :cascade do |t|
    ...
    t.index %w[repliable_type repliable_id], name: 'index_replies_on_repliable'
  end
